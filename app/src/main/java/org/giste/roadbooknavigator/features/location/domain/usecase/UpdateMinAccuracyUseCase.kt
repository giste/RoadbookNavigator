...
import org.giste.roadbooknavigator.features.location.domain.AccuracyThreshold
import org.giste.roadbooknavigator.features.location.domain.LocationSettingsRepository
import javax.inject.Inject

/**
 * Use case to update the minimum horizontal accuracy.
 */
class UpdateMinAccuracyUseCase @Inject constructor(
    ...
    suspend operator fun invoke(accuracy: Float): Result<Unit> = runCatching {
        ...
        repository.updateMinAccuracy(accuracy)
    }
}
