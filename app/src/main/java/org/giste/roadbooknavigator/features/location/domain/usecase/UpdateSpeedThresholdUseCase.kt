...
import org.giste.roadbooknavigator.features.location.domain.SpeedThreshold
import javax.inject.Inject

/**
 * Use case to update the speed threshold.
 */
class UpdateSpeedThresholdUseCase @Inject constructor(
    ...
    suspend operator fun invoke(threshold: Float): Result<Unit> = runCatching {
        ...
        repository.updateSpeedThreshold(threshold)
    }
}
