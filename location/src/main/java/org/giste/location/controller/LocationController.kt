 ...
 *
 * This class coordinates the stateless observation logic with settings provided by
 * [LocationSettingsProvider] to provide a single, shared source of location truth.
 */
@Singleton
internal class LocationController @Inject constructor(
    ...
    private val locationEvents: Flow<LocationEvent> = locationSettingsProvider.settings
