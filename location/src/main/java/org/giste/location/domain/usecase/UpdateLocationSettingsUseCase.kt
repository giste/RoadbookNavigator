...
/**
 * Use case to update location settings.
 */
internal class UpdateLocationSettingsUseCase @Inject constructor(
    private val repository: LocationSettingsRepository
) {
    suspend operator fun invoke(settings: LocationSettings) {
        // Validation could be added here in the future
        repository.saveLocationSettings(settings)
    }
}
