...
class RemoteMapFolderTest {
    ...
    fun `filterMaps should remove downloaded maps`() {
        ...
        Assert.assertEquals(1, filtered!!.maps.size)
        Assert.assertEquals("map2", filtered.maps[0].name)
    }
    ...
    fun `filterMaps should recursively filter subfolders`() {
        ...
        Assert.assertNotNull(filtered)
        Assert.assertEquals(1, filtered!!.subFolders.size)
        Assert.assertEquals(1, filtered.subFolders[0].maps.size)
        Assert.assertEquals("map2", filtered.subFolders[0].maps[0].name)
    }
