...
/**
 * Public interface for interacting with the Roadbook module.
 * Allows the consumer to send commands and observe events and state.
 */
public interface RoadbookController {
    /**
