...
package org.giste.roadbooknavigator.features.roadbook.ui.components
...
/**
 * A specialized [Text] composable for the Roadbook that supports auto-sizing.
 ...
 */
@Composable
public fun RoadbookAutoSizeText(
    text: String,
