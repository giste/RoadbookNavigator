...
class UpdateOdometerKeysUseCaseTest {
    ...
    private lateinit var useCase: UpdateOdometerKeysUseCase

    @Before
    fun setup() {
        useCase = UpdateOdometerKeysUseCase(repository, updateRemoteModelUseCase)
    ...
    fun `invoke should update keys and set model to CUSTOM`() = runTest {
        ...
        val result = useCase(inc, dec, res)
